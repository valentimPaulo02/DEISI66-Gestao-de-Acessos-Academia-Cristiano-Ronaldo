...
INSERT INTO `user` VALUES (1,'test','test','test','test','athlete',NULL,'under15'),(3,'test','test','test2','test','admin',NULL,NULL);
...
CREATE TABLE `weekendrequest` (
  ...
  `state` enum('pending','refused','authorized') DEFAULT NULL,
  `validated` tinyint(1) DEFAULT NULL,
  `leave_if_called_up` tinyint(1) DEFAULT NULL,
  `leave_if_not_called_up` tinyint(1) DEFAULT NULL,
  `if_called_up_leave_date` date DEFAULT NULL,
  `if_called_up_leave_time` time DEFAULT NULL,
  `if_not_called_up_leave_date` date DEFAULT NULL,
  `if_not_called_up_leave_time` time DEFAULT NULL,
  `supervisor` varchar(50) DEFAULT NULL,
  `transport_out` varchar(50) DEFAULT NULL,
  `destiny` varchar(50) DEFAULT NULL,
  `arrival_date` date DEFAULT NULL,
  `arrival_time` time DEFAULT NULL,
  `transport_in` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`request_id`),
  KEY `user_id` (`user_id`),
...
-- Dump completed on 2023-11-28 21:05:03
